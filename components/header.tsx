  ...
  return (
    <header className="sticky top-0 z-50 border-b border-olive/10 bg-background/88 backdrop-blur-xl">
      <div className="container-shell py-3 sm:py-4">
        ...
        <div className="mt-3 hidden items-center justify-between gap-4 border-t border-olive/10 pt-3 lg:flex">
          <div className="flex items-center gap-5 text-sm font-medium text-foreground/72">
            {categories.slice(0, 6).map((category) => {
              ...
              return (
                <button
                  ...
                  className={isActive ? "text-olive-dark" : "hover:text-olive-dark"}
                >
                  {category}
                </button>
              );
          ...
          <div className="rounded-full bg-olive-soft px-3 py-1.5 text-xs font-semibold text-olive-dark">
