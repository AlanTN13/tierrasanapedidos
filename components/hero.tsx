...
export function Hero({ content }: HeroProps) {
  ...
  return (
    <section id="inicio" className="container-shell pt-4 pb-7 sm:pt-6 sm:pb-9 lg:pt-3 lg:pb-7.5">
      <div className="surface-panel organic-outline hero-garden relative overflow-hidden rounded-[2.25rem] px-3 py-3 sm:px-4 sm:py-4 lg:px-4 lg:py-3.5">
        ...
        <div className="relative">
          <article className="organic-outline relative overflow-hidden rounded-[1.8rem] bg-white/55 shadow-[0_20px_36px_rgba(111,127,79,0.12)]">
            <div className="relative aspect-[1.9/1] sm:aspect-[2.25/1] lg:aspect-[2.65/1]">
              <Image
